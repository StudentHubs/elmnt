...
var icons = {
    ...
    cross: {
        path: 'M323.1 441l53.9-53.9c9.4-9.4 9.4-24.5 0-33.9L279.8 256l97.2-97.2c9.4-9.4 9.4-24.5 0-33.9L323.1 71c-9.4-9.4-24.5-9.4-33.9 0L192 168.2 94.8 71c-9.4-9.4-24.5-9.4-33.9 0L7 124.9c-9.4 9.4-9.4 24.5 0 33.9l97.2 97.2L7 353.2c-9.4 9.4-9.4 24.5 0 33.9L60.9 441c9.4 9.4 24.5 9.4 33.9 0l97.2-97.2 97.2 97.2c9.3 9.3 24.5 9.3 33.9 0z',
        viewBox: '-80 -80 544 672',
    },
    up: {
...
exports.default = refluent_1.default
    ...
    var base = style.numeric('paddingTop', 'paddingRight', 'paddingBottom', 'paddingLeft');
    return {
        div: base
            .filter.apply(base, __spread(css_1.default.groups.box, css_1.default.groups.other)).merge({ display: 'block', position: 'relative' }),
    ...
    return (React.createElement("div", { style: style.div },
        React.createElement(icon_1.default, __assign({}, icons[type], { style: style.icon })),
        React.createElement("div", { style: { position: 'absolute', top: 0, right: 0, bottom: 0, left: 0 } })));
});
